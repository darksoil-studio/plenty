...
pub async fn create_order(conductor: &SweetConductor, zome: &SweetZome, order: Order) -> Record {
    let record: Record = conductor.call(zome, "create_order", order).await;
    record
}

pub async fn sample_household_order_1(
    conductor: &SweetConductor,
    zome: &SweetZome,
) -> HouseholdOrder {
    HouseholdOrder {
        order_hash: create_order(conductor, zome, sample_order_1(conductor, zome).await)
            .await
            .signed_action
            .hashed
            .hash,
...
pub async fn sample_household_order_2(
    conductor: &SweetConductor,
    zome: &SweetZome,
) -> HouseholdOrder {
    HouseholdOrder {
        order_hash: create_order(conductor, zome, sample_order_2(conductor, zome).await)
            .await
            .signed_action
            .hashed
            .hash,
...
pub async fn create_household_order(
    conductor: &SweetConductor,
    zome: &SweetZome,
...
pub async fn sample_producer_delivery_1(
    conductor: &SweetConductor,
    zome: &SweetZome,
) -> ProducerDelivery {
    ProducerDelivery {
...
pub async fn sample_producer_delivery_2(
    conductor: &SweetConductor,
    zome: &SweetZome,
) -> ProducerDelivery {
    ProducerDelivery {
...
pub async fn create_producer_delivery(
    conductor: &SweetConductor,
    zome: &SweetZome,
...
pub async fn sample_producer_invoice_1(
    conductor: &SweetConductor,
    zome: &SweetZome,
) -> ProducerInvoice {
    ProducerInvoice {
...
pub async fn sample_producer_invoice_2(
    conductor: &SweetConductor,
    zome: &SweetZome,
) -> ProducerInvoice {
    ProducerInvoice {
...
pub async fn create_producer_invoice(
    conductor: &SweetConductor,
    zome: &SweetZome,
...
pub async fn sample_available_products_1(
    conductor: &SweetConductor,
    zome: &SweetZome,
) -> AvailableProducts {
    AvailableProducts {
...
pub async fn sample_available_products_2(
    conductor: &SweetConductor,
    zome: &SweetZome,
) -> AvailableProducts {
    AvailableProducts {
...
pub async fn create_available_products(
    conductor: &SweetConductor,
    zome: &SweetZome,
