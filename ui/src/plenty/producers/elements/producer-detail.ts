...
export class ProducerDetail extends SignalWatcher(LitElement) {
  ...
  async deleteProducer() {
    try {
      ...
      this.dispatchEvent(
        new CustomEvent("producer-deleted", {
          bubbles: true,
          composed: true,
          detail: {
      ...
      <sl-card>
        ...
        <div class="column" style="gap: 16px;">
          ...
          <div class="column" style="gap: 8px;">
            ...
            <span style="white-space: pre-line"
              >${entryRecord.entry.contact_email}</span
            >
          </div>
          ...
          <div class="column" style="gap: 8px;">
            ...
            <span style="white-space: pre-line"
              >${entryRecord.entry.phone_number}</span
            >
          </div>
          ...
          <div class="column" style="gap: 8px;">
            ...
            <span style="white-space: pre-line"
              >${entryRecord.entry.producer_details}</span
            >
          </div>
          ...
          <div class="column" style="gap: 8px;">
            ...
            <span style="white-space: pre-line"
              >${entryRecord.entry.editors.type === "Liason"
                ? "Liason"
                : entryRecord.entry.editors.type === "AllMembers"
                  ? "All Members"
                  : "Members"}</span
            >
          </div>
